...
void MICS6814::calibrate()
{
	...
	do{
		...
		pntrNO2 = (pntrNO2 + 1)% seconds;
	    	// Serial.print(pntrNH3); Serial.print(" ");
			// Serial.print(pntrCO); Serial.print(" ");
			// Serial.print(pntrNO2); Serial.println(" ");

			// Serial.print(isStableNH3); Serial.print(" ");
			// Serial.print(isStableCO); Serial.print(" ");
			// Serial.print(isStableNO2); Serial.println(" ");
